...
\label{sub:dtcoq}	
	...
	ordinary user code.
	 ...
	 For instance, in Coq natural numbers are inductively defined as depicted by Listing \ref{lst:nat}:
		...
		\lstinputlisting[language=Coq, label=lst:nat, caption=\textsf{nat} datatype]{listings/chapter2/nat.tex}
	...
	\lstinputlisting[language=Coq, label=lst:list, caption=\textsf{list} datatype]{listings/chapter2/list.tex}
...
\label{sub:fpcoq}
	...
	the \textsf{plus} function is given by Listing \ref{lst:plus}.
		...
		\lstinputlisting[language=Coq, label=lst:plus, caption=\textsf{plus} function definition]{listings/chapter2/plus.tex}	
	...
	depicted by Listing \ref{lst:sizelist}.
		...
		\lstinputlisting[language=Coq, label=lst:sizelist, caption=\textsf{length} function definition]{listings/chapter2/sizelist.tex}
	...
	usually handles such situations by raising an exception, but this is not possible in Coq.
		...
		\lstinputlisting[language=Coq, label=lst:option, caption=\textsf{option} datatype]{listings/chapter2/option.tex}
	...
	\lstinputlisting[language=Coq, label=lst:head, caption=\textsf{head} function definition]{listings/chapter2/head.tex}
	...
	\lstinputlisting[language=Coq, label=lst:vector, caption=\textsf{vector} datatype]{listings/chapter2/vector.tex}
	...
	\lstinputlisting[language=Coq, label=lst:vhead, caption=\textsf{vhead} function definition]{listings/chapter2/vhead.tex}
...
\label{sub:provecoq}	
	...
	\lstinputlisting[language=Coq, label=lst:even, caption=\textsf{is\_even} predicate definition]{listings/chapter2/even.tex}		
	...
	\lstinputlisting[language=Coq, label=lst:even4, caption=Proof that 4 is even]{listings/chapter2/even4.tex}
	...
	\lstinputlisting[language=Coq, label=lst:permut, caption=\textsf{permut} predicate definition]{listings/chapter2/permut.tex}
...
\end{prooftree}	
	...
	\lstinputlisting[language=Coq, label=lst:permutproof, caption=Permutation proof example]{listings/chapter2/permutproof.tex}	
...
\label{sub:coqextract}	
	...
	\centering
	\lstinputlisting[language=Coq, frame=1rb, caption=original \textsf{vhead} function]{listings/chapter2/vhead2.tex}
	%\label{lst:component}
	\end{minipage}
	\hspace{0.05cm}
	\begin{minipage}[b]{0.5\linewidth} 
	\centering
	\lstinputlisting[language=OCaml, stepnumber=0, frame=1rb, caption=Extracted \textsf{vhead} function]{listings/chapter2/vheadex.tex}
	%\label{lst:binding}
	\end{minipage}
	\end{figure}	  		
