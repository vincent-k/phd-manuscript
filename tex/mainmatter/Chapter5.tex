...
\label{sub:painlessproactive}
	...
	%	Finally, we use Coq's extraction mechanism to obtain certified OCaml
	%code	concerning the evaluation of \textsf{operations} on \textsf{component}
	%architectures. Indeed, together, the \textit{build\_state} and 
	%\textit{well\_typed\_bool} functions act as a decision procedure for the
	%validity of a given operation. 
