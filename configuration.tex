...
\lstdefinelanguage{Painless}{  
 ...
 morecomment=[n]{(*}{*)},  %nested comment
  ...
  stringstyle=\color{orange},         % string literal style
  escapeinside={\%*}{*)},            % if you want to add a comment within your code
  morekeywords={Architecture, Reconfiguration, Require},            
 morekeywords={[2] with, match, end, if, then, else, let, in, deploy, reconfigure},       
 morekeywords={[3] Interface, Component, Normal, Import, Export, Client, Server, Functional, External, Internal, Singleton, Multicast, Mandatory, Optional}
}
